...
variable "playbook_ansible" {
  type = string
  default = "ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook ansible.yml"
}

variable "domain" { default = "local" }

variable "memoryMB" { default = 2048 }

variable "cpu" { default = 2 }

variable "image" {
  type = list(string)
  default = ["/home/dauka/Desktop/images/ubuntu.img", "/home/dauka/Desktop/images/ubuntu.img"]
}
...
disk {
  ...
  provisioner "remote-exec" {
    inline = ["sudo apt update -y", "sudo apt install python3 -y"]
